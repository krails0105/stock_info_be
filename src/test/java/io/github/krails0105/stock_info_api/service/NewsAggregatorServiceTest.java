...
class NewsAggregatorServiceTest {
  ...
  class SortingTests {
    ...
    void testHighImportanceFirst() {
      NewsItem lowNews = NewsItem.builder()
          .title("시장 루머")
          .publisher("온라인")
          .publishedAt(LocalDateTime.now())
          .url("https://example.com/1")
      ...
      NewsItem highNews = NewsItem.builder()
          .title("대규모 수주")
          .publisher("한경")
          .publishedAt(LocalDateTime.now().minusHours(1))
          .url("https://example.com/2")
    ...
    void testNewerNewsFirst() {
      NewsItem oldNews = NewsItem.builder()
          .title("실적 발표 A")
          .publisher("한경")
      ...
      NewsItem newNews = NewsItem.builder()
          .title("실적 발표 B")
          .publisher("매경")
          .publishedAt(LocalDateTime.now())
          .url("https://example.com/2")
  ...
  class RumorFilterTests {
    ...
    void testIsRumorOnly() {
      NewsItem rumorOnly = NewsItem.builder()
          .title("인수설")
          .publisher("온라인")
          .publishedAt(LocalDateTime.now())
          .url("https://example.com/1")
      ...
      NewsItem mixed = NewsItem.builder()
          .title("수주+루머")
          .publisher("한경")
          .publishedAt(LocalDateTime.now())
          .url("https://example.com/2")
    ...
    void testFilterForReasonCards() {
      ...
      NewsItem earnings = NewsItem.builder()
          .title("실적 발표")
          .publisher("한경")
          .publishedAt(LocalDateTime.now())
          .url("https://example.com/2")
      ...
      List<NewsItem> result = newsAggregatorService.filterForReasonCards(
          List.of(rumorOnly, earnings));
